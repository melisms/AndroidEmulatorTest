        ...
        if (driver == null) {
            ...
            switch (ConfigReader.getProperty("platformName")) {
             ...
             //  options.setApp(ConfigReader.getProperty("app"));
               options.setApp(ConfigReader.getProperty("app"));
               //options.setCapability("appPackage", ConfigReader.getProperty("APP_PACKAGE"));
               //options.setCapability("appActivity", ConfigReader.getProperty("APP_ACTIVITY"));
               options.setCapability("activity", ConfigReader.getProperty("app_activity"));
               options.setCapability("package", ConfigReader.getProperty("app_package"));
